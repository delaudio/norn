...
- **Verification:** 617 Rust library tests pass with 2 ignored and 32
  ...
  snapshots. Norn branch reviews through `run-1788685874025520000` drove these
  remediations. The next bounded review is pending.
  Implementation commits through `eeef2e8` and release metadata commit
