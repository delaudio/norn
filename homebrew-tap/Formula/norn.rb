class Norn < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/lachesi-hq/lachesi/releases/download/v#{version}/norn-#{version}-macos-arm64.tar.gz"
      sha256 :no_check
    else
      url "https://github.com/lachesi-hq/lachesi/releases/download/v#{version}/norn-#{version}-macos-x86_64.tar.gz"
      sha256 :no_check
    end
  end
